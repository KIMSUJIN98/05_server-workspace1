...
public class RequestGetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("foods : " + foods[0]); ["한식", "일식"] | null => 오류날 수 있음	// 주어진(체크된) 값이 없는 경우 null에 접근하므로 에러발생
	    ...
	    */
		...
		// 즉, 여기 "Java 코드 내에" 사용자가 보게될 응답 html 구문 작성할꺼!!
		...
		// 1) 이제부터 내가 출력할 내용은 문서형태의 html이고 문자인코딩 문자셋은 utf-8이다 라는걸 선언
